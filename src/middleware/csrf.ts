...
/**
 * CSRF middleware function for API routes
 */
export function csrfProtection(
  ...
  // Get session ID (you would get this from your auth system)
  if (!sessionId) {
  ...
  if (!validation.valid) {
    console.warn(`[CSRF] Validation failed for session ${sessionId}: ${validation.error}`);
